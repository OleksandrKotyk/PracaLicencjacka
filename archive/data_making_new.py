...
#
#     print("Quantity of the words:", len(words))
#
#     if is_ig:
...
#
#     return x_train_pre, x_test_pre, x_train_vec, x_test_vec, x_train_vec_td_idf, x_test_vec_td_idf, y_test, y_train, enum_words, pad_len
